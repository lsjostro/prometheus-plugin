...
public class ExecutorsDefinedGaugeTest extends MockedLoadStatisticSnapshotTest {


    @Test
    public void testCollectResult() {

        when(mock.getDefinedExecutors()).thenReturn(10);

        ExecutorsDefinedGauge sut = new ExecutorsDefinedGauge(getLabelNames(), getNamespace(), getSubSystem(), "");
        ...
        validateNames(samples, new String[]{"default_jenkins_defined"});
        validateMetricFamilySampleSize(samples, 1);
        validateHelp(samples, "Executors Defined");
