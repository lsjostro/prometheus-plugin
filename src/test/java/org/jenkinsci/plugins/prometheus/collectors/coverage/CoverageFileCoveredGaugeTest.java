...
public class CoverageFileCoveredGaugeTest extends CoverageTest {


    public CoverageFileCoveredGaugeTest() {
    ...
    public void testCovered() {
        ...
        CoverageFileCoveredGauge sut = new CoverageFileCoveredGauge(new String[]{"job"}, getNamespace(), getSubSystem());
