...
public class CoverageClassMissedGaugeTest extends CoverageTest {


    public CoverageClassMissedGaugeTest() {
    ...
    public void testCovered() {
        ...
        CoverageClassMissedGauge sut = new CoverageClassMissedGauge(new String[]{"job"}, getNamespace(), getSubSystem());
