...
public class CoverageBranchTotalGaugeTest extends CoverageTest {


    public CoverageBranchTotalGaugeTest() {
    ...
    public void testMissed() {
        ...
        CoverageBranchTotalGauge sut = new CoverageBranchTotalGauge(new String[]{"job"}, getNamespace(), getSubSystem());
