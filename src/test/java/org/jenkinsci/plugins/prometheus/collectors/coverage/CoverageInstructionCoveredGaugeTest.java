...
public class CoverageInstructionCoveredGaugeTest extends CoverageTest {


    public CoverageInstructionCoveredGaugeTest() {
    ...
    public void testCovered() {
        ...
        CoverageInstructionCoveredGauge sut = new CoverageInstructionCoveredGauge(new String[]{"job"}, getNamespace(), getSubSystem());
