...
public class CoverageClassCoveredGaugeTest extends CoverageTest {


    public CoverageClassCoveredGaugeTest() {
    ...
    public void testCovered() {
        ...
        CoverageClassCoveredGauge sut = new CoverageClassCoveredGauge(new String[]{"job"}, getNamespace(), getSubSystem());
